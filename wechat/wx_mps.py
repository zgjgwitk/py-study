    ...
    def start(self):
        ...
        while True:
            api = 'https://mp.weixin.qq.com/mp/profile_ext?action=getmsg&__biz={biz}&f=json&offset={offset}' \
                  ...
                  '={token}&x5=1&f=json'.format(
                      biz=self.biz, offset=offset, ticket=self.pass_ticket, token=self.msg_token)
            print(api)
            ...
            if ret == 0 or status == 'ok':
                ...
                for msg in msg_list:
                    ...
                    app_msg_ext_info = msg.get(
                        'app_msg_ext_info')  # article原数据
                    if app_msg_ext_info:
                        # 本次推送的首条文章
                        self._parse_articles(
                            app_msg_ext_info, msg_id, post_time)
                        # 本次推送的其余文章
...
if __name__ == '__main__':
    ...
    pass_ticket = 'Dk1PHNV+B8Tsyyln2k+z+K8xXpoOsMsDD1hSub6IGxxcrZKbgzaSvEOSyYae4Mjc'
    app_msg_token = '1079_pjLACgwUGHGfK94I4CYpiytQM-WeTw-N_9uu5Q~~'
    cookie = 'wap_sid2=CMzLvYIGEooBeV9IUFlOVEd2VDFBMWUxZUJfeVdobW1IY19NWHZlWENWd0dCUm9yVUkybE9kblExUUxOdTJ2Zl8yN050a1RtWXlGejUzX0pmSGt0UE1KT3g5U0FZRnh0aDJCZE5ZZkluX3VNR1BSeko2cWc0U0VBdVVqRzdEVGZvcVRIZ2laTkhaMXp4UVNBQUF+MJWPkvsFOA1AlU4='
